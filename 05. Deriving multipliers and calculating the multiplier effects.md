...
> We can say the formula for $G$ is $G = 0.6 \cdot + 97.6$
...
The sum of a geometric progression: $\dfrac{1 - q^n}{1 - q} \text{, } n \rightarrow \infin \Rightarrow \dfrac{1}{1 - q} = \dfrac{1}{1 - 0.6} = 2.5$