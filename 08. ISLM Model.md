...
&emsp; $IS: y^* = \dfrac{1}{1 - c \cdot (1 - t) + \dfrac{b \cdot k}{h}} \cdot \left(C _0 - c \cdot T _0 + c \cdot Tr + I _0 + \overline{G} + \dfrac{b}{h} \cdot \dfrac{M}{p} \right)$  
&emsp; $LM: y = \dfrac{1}{k} \cdot \dfrac{M}{p} + \dfrac{h}{k} \cdot r$  
...
(b)  
&emsp; $r^* = \dfrac{k}{h} \cdot y^* - \dfrac{1}{h} \cdot \dfrac{M}{p}$  
&emsp; To calculate the equilibrium we use the ISLM equilibrium:  
