...
1. The following historical data sets describe the evolution of the average monthly gross nominal wage and of the Consumer Price Index (CPI) in Romania during the years 2012-2018:  
...
3. In a closed economy the propensity of consumption is $c = 0.9$ and the tax rate $t = 0.3$. A decrease in the government expenditures by 10 bil. &euro; will lead to a change in GDP by about:  
...
4. In case of a flexible exchange rate and a weak capital mobility, a decrease of the nominal exchange rate lei/€ from 4.85 to 4.7 leads to:  
...
5. The amount of the fixed capital depreciation is not part of the following macroeconomic indicator:  
...
&emsp; The correct answer is **()** because

---

6. Given that the annual nominal interest rate is 2% and the CPI for the same year is 101.5%, the real interest rate is:  
...
8. In an IS-LM model the propensity of consumption is $c = 0.75$, the tax rate is $t = 0.2$, $b = 1000$, $k = 0.3$ and $h = 500$. Identify the correct relation, where $\alpha _G$ represents the multiplier of government expenditures on the
...
9. The changes in inventories represent:  
...
10. The income obtained by an Italian working in a Romanian company is part of:

&emsp;&emsp; (a) the Romanian GNP and the Italian GDP  
&emsp;&emsp; (a) the Romanian GNP and the Italian GNP  
&emsp;&emsp; (a) the Romanian GDP and the Italian GNP  
&emsp;&emsp; (a) none of the above  
