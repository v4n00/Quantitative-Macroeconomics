...
&emsp; (a) Based on the Keynesian theory and the IS-LM model, what macroeconomic effects do you think were expected to be achieved through this policy? (1 p)  
&emsp; (b) Comment upon the effectiveness of Obama’s policy in such business cycle phase. (0.5 p)
