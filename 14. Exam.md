...
- [Exam](#exam)
  ...
  - [Quiz questions (justifications required)](#quiz-questions-justifications-required)
...
&emsp; The correct answer is **(c)** because this makes imports cheaper and exports more expensive, as a result, imports increase and exports decrease, leading to a larger trade deficit.
...
&emsp; $\Delta y ^ * = \Gamma _{BP} \cdot c \cdot \Delta Tr + \Gamma _{MP} \cdot \Delta \dfrac{M}{p}$  
&emsp; $\Delta y ^ * = 1.6 \cdot 0.75 \cdot 50 + 0.8 \cdot 50$  
&emsp; $\Delta y ^ * = 100$ mil. &euro;  
&emsp; $y ^ { * * } = 2400 + 100 = 2500$ mil. &euro;  

&emsp; $\Delta r ^ * = \dfrac{k}{h} \cdot \Delta y ^ * - \left(\dfrac{1}{h} \cdot \Delta \dfrac{M}{p}\right) = \dfrac{0.25}{400} \cdot 100 - \dfrac{1}{400} \cdot 50$  
