...
&emsp; $BD = G - T + Tr + Sv$  
&emsp; $\Rightarrow BD = 500 - 400 + 0 + 0 = 100$ bil. &euro;  
...
&emsp; $\Delta y = \alpha _G \cdot (\underset{=0}{\Delta C _0} + \underset{=0}{c \cdot \Delta Tr} + \underset{\not=0}{c \cdot \Delta T _0} + \underset{=0}{\Delta I} + \underset{=0}{\Delta G})$  
...
&emsp; $\Delta BD = \underset{=0}{\Delta G} - \underset{\not ={0}}{\Delta T _0} - \underset{\not=0}{t \cdot \Delta y} + \underset{= 0}{\Delta Tr} + \underset{= 0}{\Delta Sv}$  
...
&emsp; $\Delta C = \underset{=0}{\Delta C _0} + \underset{\not=0}{c \cdot (1 - t) \cdot \Delta y} - \underset{\not=0}{c \cdot \Delta T _0} + \underset{\not=0}{c \cdot \Delta Tr}$  
...
&emsp; $\Delta y = \alpha _G \cdot \underset{=0}{\Delta C _0} + \underset{\not=0}{c \cdot \Delta Tr} - \underset{=0}{c \cdot \Delta T _0} + \underset{=0}{\Delta I} + \underset{\not=0}{\Delta G}$  
$\Delta y = \alpha _G \cdot (c \cdot \Delta Tr + \Delta G)$  
$\Delta y = \underset{>0}{\alpha _G} \cdot \underset{>0}{(1 - c)} > 0$  
$BD = G - T + Tr + Sv$  
$\Delta BD = \underset{\not=0}{\Delta G} - \underset{=0}{\Delta T _0} - \underset{\not=0}{t \cdot \Delta y} + \underset{\not=0}{\Delta Tr} + \underset{= 0}{\Delta Sv}$  
